    ...
    public partial class models : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AlumnosAlumnoId = table.Column<int>(type: "INTEGER", nullable: false),
                    ClasesClaseId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlumnoClase", x => new { x.AlumnosAlumnoId, x.ClasesClaseId });
                    table.ForeignKey(
                        name: "FK_AlumnoClase_Alumno_AlumnosAlumnoId",
                        column: x => x.AlumnosAlumnoId,
                        principalTable: "Alumno",
                        principalColumn: "AlumnoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlumnoClase_Clase_ClasesClaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlumnoClase_ClasesClaseId",
                table: "AlumnoClase",
